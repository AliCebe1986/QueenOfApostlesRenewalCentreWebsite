    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Room>().HasData(
                ...
                new Room { RoomId = 33, RoomNumber = "33", Name = "Room 33", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 34, RoomNumber = "34", Name = "Room 34", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 35, RoomNumber = "35", Name = "Room 35", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 36, RoomNumber = "36", Name = "Room 36", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 37, RoomNumber = "37", Name = "Room 37", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 38, RoomNumber = "38", Name = "Room 38", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 39, RoomNumber = "39", Name = "Room 39", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 40, RoomNumber = "40", Name = "Room 40", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 41, RoomNumber = "41", Name = "Room 41", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 42, RoomNumber = "42", Name = "Room 42", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 43, RoomNumber = "43", Name = "Room 43", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 44, RoomNumber = "44", Name = "Room 44", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 45, RoomNumber = "45", Name = "Room 45", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 46, RoomNumber = "46", Name = "Room 46", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 47, RoomNumber = "47", Name = "Room 47", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 48, RoomNumber = "48", Name = "Room 48", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 49, RoomNumber = "49", Name = "Room 49", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 50, RoomNumber = "50", Name = "Room 50", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 51, RoomNumber = "51", Name = "Room 51", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 52, RoomNumber = "52", Name = "Room 52", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 53, RoomNumber = "53", Name = "Room 53", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 54, RoomNumber = "54", Name = "Room 54", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 55, RoomNumber = "55", Name = "Room 55", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 56, RoomNumber = "56", Name = "Room 56", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 57, RoomNumber = "57", Name = "Room 57", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 58, RoomNumber = "58", Name = "Room 58", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 59, RoomNumber = "59", Name = "Room 59", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 60, RoomNumber = "60", Name = "Room 60", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 61, RoomNumber = "61", Name = "Room 61", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 62, RoomNumber = "62", Name = "Room 62", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 63, RoomNumber = "63", Name = "Room 63", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false },
                new Room { RoomId = 64, RoomNumber = "64", Name = "Room 64", Capacity = 2, Type = "Standard", WithShower = true, IsReserved = false }
            );
        }
    }
}